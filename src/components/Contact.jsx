  ...
  const contactInfo = [
    {
      ...
      title: 'Email',
      content: 'vangurupradeep123@gmail.com ',
      link: 'mailto:vangurupradeep123@gmail.com '
    },
    {
      icon: <Phone className="w-6 h-6 text-green-600 dark:text-green-400" />,
      title: 'Phone',
      content: '+91 7386385309',
      link: 'tel:+917386385309'
    },
    {
      icon: <MapPin className="w-6 h-6 text-red-600 dark:text-red-400" />,
      title: 'Location',
      content: 'Vijayawada,India',
      link: 'https://maps.app.goo.gl/y36Aife5hCB6LiDm7'
    }
  ];
          ...
          >
            ...
            <div className="mt-10">
              ...
              <div className="flex space-x-4">
                ...
                <a 
                  href="https://x.com/VanguruPradeep" 
                  className="w-10 h-10 rounded-full bg-gray-100 dark:bg-gray-700 flex items-center justify-center text-gray-600 dark:text-gray-400 hover:bg-primary hover:text-white transition-colors"
                  aria-label="Twitter"
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <a 
                  href="https://www.instagram.com/pr_adeep__18/?utm_source=ig_web_button_share_sheet" 
                  className="w-10 h-10 rounded-full bg-gray-100 dark:bg-gray-700 flex items-center justify-center text-gray-600 dark:text-gray-400 hover:bg-primary hover:text-white transition-colors"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-primary focus:border-transparent bg-white dark:bg-gray-800"
                  />
                </div>
                <div>
